...
class MainWindow():
    def __init__(self, root) -> None:
        ...
        self.label_receipt_number.grid(row=1, column=0, padx=5, pady=5)
        self.entry_receipt_number = Entry(root)
        self.entry_receipt_number.grid(row=1, column=1)

        self.label_item = Label(root, text="Item:")
        self.label_item.grid(row=2, column=0, padx=5, pady=5)
